...
class Practica1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Práctica 2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Práctica 2")
        ...
        self.qtgui_number_sink_0_0.set_title("Desviación Estandar")
        ...
        self.connect((self.epy_block_0, 0), (self.qtgui_time_sink_x_2_1, 0))
        self.connect((self.epy_block_0, 2), (self.qtgui_time_sink_x_2_1, 2))
        self.connect((self.epy_block_0, 4), (self.qtgui_time_sink_x_2_1, 4))
        self.connect((self.epy_block_0, 1), (self.qtgui_time_sink_x_2_1, 1))
        self.connect((self.epy_block_0, 3), (self.qtgui_time_sink_x_2_1, 3))
