...
import Practica4_epy_block_0 as epy_block_0  # embedded python block
import math
import sip
import threading
...
class Practica4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica4")
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.qtgui_time_sink_x_0_3, 0))
